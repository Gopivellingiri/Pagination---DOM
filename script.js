...
// var iterate = result.length / 10;

// var clicked = document.querySelector('#btn-1')
// clicked.addEventListener('click',()=>{
//   var runClick = clicked
//  var count = parseInt(runClick.getAttribute('for'))
// console.log(result[count])
// var obtainedData = result[count]
// var creatingDiv = document.createElement('div')
// creatingDiv.innerHTML =`<p for="${obtainedData}">${obtainedData.id}</p>
// <p for="name">${obtainedData.name}</p>
// <p for="email">${obtainedData.email}</p>`
// document.querySelector('.parent-data').append(creatingDiv)
// })

// console.log(click);
// for(var i = 1; i < click.length; i++){
//   click.addEventListener('onclick',()=>{
//       click[i].getAttribute('for')
//   })
